...
import { Flame, TrendingUp, Sparkles, AlertTriangle, Trophy, Brain, Loader2, ChevronRight } from "lucide-react";
...
export default function CoachInsights({ compact = false }) {
  ...
  if (loading) {
    return (
      <div className="af-card p-4 sm:p-5 mb-5 sm:mb-6 clip-corner-tl-br" data-testid="coach-insights-loading">
  ...
  return (
    <div className="af-card p-4 sm:p-5 mb-5 sm:mb-6 clip-corner-tl-br tracing-border" data-testid="coach-insights">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <div className="relative w-9 h-9 hex-shield flex items-center justify-center pulse-glow" style={{ background: "linear-gradient(180deg, #00E5FF, #1E90FF)" }}>
          ...
          <div>
            ...
            <div className="font-teko text-xl chrome-text leading-none">Deine Wochen-Analyse</div>
          </div>
        </div>
      </div>
      ...
      {compact && data.insights.length > 2 && (
